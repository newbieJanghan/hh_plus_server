...
public class OrderApplication {
	...
	@Autowired
	public OrderApplication(OrderService orderService, ProductService productService, BalanceService balanceService) {
	...
	public Order run(CreateOrderDto createOrderDto) {
		...
		balanceService.use(order.getUserId(), order.getTotalPrice());
